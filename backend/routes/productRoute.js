...
const { getallproducts, createproducts, updateproducts, deleteproducts, getproducts, createProductReview, getAllReview, deleteReview, getCategoryProduct, getAdminproducts } = require('../controller/productcontroller');
